...
# Copyright (c)2004,2012, 2013, 2016
# by Brian Manning <cpan@xaoc.org>
...
${SCRIPTNAME} [options] <command>
   ...
   -w|--webapp    Web app framework (Mojolicious/Dancer2) modules
...
if [ $LIST_MODULES -gt 0 ]; then
   INSTALL_MODULES="$BASE_MODULES $ARCHIVE_MODULES $DB_MODULES
      $MISC_MODULES $GTK_MODULES $WEBAPP_MODULES"
   echo "The following modules are configured to install:"
   # sort and print out the list of modules
